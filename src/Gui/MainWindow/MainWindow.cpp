...
const char COMMUNITY_FORUM_URL[] = "https://bitcointalk.org/index.php?topic=2197967";
const char REPORT_ISSUE_URL[] = "https://getsikka.org/contact";
...
MainWindow::MainWindow(ICryptoNoteAdapter* _cryptoNoteAdapter, IAddressBookManager* _addressBookManager,
  ...
  m_ui->setupUi(this);
  setWindowTitle(tr("Sikka Wallet %1").arg(Settings::instance().getVersion()));
